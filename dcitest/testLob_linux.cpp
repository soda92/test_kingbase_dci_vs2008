...
drop_table(char *table_name)
{
	...
	err = DCIStmtPrepare(pStmt, pError, (const DciText *)drop_table, 
...
//	sprintf((char *)create_table, "create table %s(C TEXT)", table_name);
	...
	err = DCIStmtPrepare(pStmt, pError, (const DciText *)create_table, 
...
insert_table_clob(char *table_name, char *buf)
{
	...
	err = DCIStmtPrepare(pStmt, pError, (const DciText *)insert_table, 
...
select_table_clob(char *table_name, DCIDefine * pDefine, DCILobLocator *clob_loc)
{
	...
	err = DCIStmtPrepare(pStmt, pError, (const DciText *)seclect_table, 
...
//	char	*sql_creat = "CREATE TABLE TEST_LOB(C1 BYTEA, C2 TEXT)";
	...
	err = DCIStmtPrepare(pStmt, pError, (DciText *)sql_select, 
...
TestLobCopy_clob()
{
	...
	test_clob_suite test_clob[] = 
	{
		...
		{"北京人大金仓", "研发中心工程部", 45, 1, 1, "研发中心工程部", DCI_SUCCESS},
		//参数 amount 小于src_locp 表示的 LOB 对象从 src_offset 之后剩余的长度
		{"北京人大金仓", "研发中心工程部", 12, 1, 1, "研发中心金仓", DCI_SUCCESS},
		//参数 amount 等于src_locp 表示的 LOB 对象从 src_offset 之后剩余的长度
		{"北京人大金仓", "研发中心工程部", 21, 1, 1, "研发中心工程部", DCI_SUCCESS},
		//参数 amount 为 0
		{"北京人大金仓", "研发中心工程部", 0, 1, 1, "北京人大金仓", DCI_SUCCESS},

		//参数 dst_offset 大于 dst_lcop 表示的 LOB 对象长度值
		{"北京人大金仓", "研发中心工程部", 21, 22, 1, "北京人大金仓   研发中心工程部", DCI_SUCCESS},
		//参数 dst_offset 小于 dst_lcop 表示的 LOB 对象长度值
		{"北京人大金仓", "研发中心工程部", 21, 1, 1, "研发中心工程部", DCI_SUCCESS},
		//参数 dst_offset 等于 dst_lcop 表示的 LOB 对象长度值
		{"北京人大金仓", "研发中心工程部", 21, 16, 1, "北京人大金研发中心工程部", DCI_SUCCESS},
		//参数 dst_offset 为 0
		{"北京人大金仓", "研发中心工程部", 21, 0, 1, "北京人大金仓研发中心工程部", DCI_ERROR},

		//参数 src_offset 大于 src_locp 表示的 LOB 对象长度值
		{"北京人大金仓", "研发中心工程部", 21, 1, 30, "北京人大金仓", DCI_ERROR},
		//参数 src_offset 小于 src_locp 表示的 LOB 对象长度值
		{"北京人大金仓", "研发中心工程部", 21, 1, 7, "中心工程部仓", DCI_SUCCESS},
		//参数 src_offset 等于 src_locp 表示的 LOB 对象长度值
		{"北京人大金仓", "研发中心工程部",21, 1, 19, "部京人大金仓", DCI_SUCCESS},
		//参数 src_offset 为 0
		{"北京人大金仓", "研发中心工程部", 21, 1, 0, "北京人大金仓", DCI_ERROR},
...
TestLobTrim_clob()
{
	...
	test_clob_suite test_clob[] = 
	{
		...
		{"北京人大金仓信息技术股份有限公司", 48,  "北京人大金仓信息技术股份有限公司", DCI_SUCCESS},
		//参数 newlen 大于 locp 表示的 LOB 对象的长度
		{"北京人大金仓信息技术股份有限公司", 120, "北京人大金仓信息技术股份有限公司", DCI_ERROR},
		//参数 newlen 小于 locp 表示的 LOB 对象的长度
		{"北京人大金仓信息技术股份有限公司", 60,  "北京人大金仓信息技术", DCI_SUCCESS},

		{"aaaaaa", 6, "aaaaaa", DCI_SUCCESS},
		{"aaaaaa", 8, "aaaaaa", DCI_ERROR},
		{"aaaaaa", 4, "aaaa", DCI_SUCCESS},

		{"北京人大金仓信息aaaaaa技术股份有限公司", 54,  "北京人大金仓信息aaaaaa技术股份有限公司", DCI_SUCCESS},
		{"北京人大金仓信息aaaaaa技术股份有限公司", 120, "北京人大金仓信息aaaaaa技术股份有限公司", DCI_ERROR},
		{"北京人大金仓信息aaaaaa技术股份有限公司", 48,  "北京人大金仓信息aaaaaa技术股份有限", DCI_SUCCESS},
...
TestLobErase_clob()
{
	...
	test_clob_suite test_clob[] = 
	{
		...
		{"研发中心工程", 2, 2, "研  心工程", DCI_SUCCESS},
		{"研发中心工程", 6, 2, "研     ", DCI_SUCCESS},
		{"研发中心工程", 8, 2, "研     ", DCI_SUCCESS},
		{"研发中心工程", 0, 2, "研发中心工程", DCI_SUCCESS},
		{"研发中心工程", 2, 6, "研发中心工 ", DCI_SUCCESS},
		{"研发中心工程", 2, 8, "研发中心工程", DCI_SUCCESS},
		{"研发中心工程", 2, 0, "研发中心工程", DCI_ERROR},

		{"研发中aaaaaa心工程", 6, 6, "研发中aa      程", DCI_SUCCESS},
		{"研发中aaaaaa心工程", 20, 6, "研发中aa       ", DCI_SUCCESS},
		{"研发中aaaaaa心工程", 12, 6, "研发中aa       ", DCI_SUCCESS},
		{"研发中aaaaaa心工程", 0, 6, "研发中aaaaaa心工程", DCI_SUCCESS},
		{"研发中aaaaaa心工程", 6, 20, "研发中aaaaaa心工程", DCI_SUCCESS},
		{"研发中aaaaaa心工程", 6, 12, "研发中aaaaaa心工 ", DCI_SUCCESS},
...
TestLobErase_clob_enablebuffering()
{
	...
	test_clob_suite test_clob[] = 
	{
		...
		{"研发中心工程", 2, 2, "研  心工程", DCI_ERROR},
		{"研发中心工程", 6, 2, "研     ", DCI_ERROR},
		{"研发中心工程", 8, 2, "研     ", DCI_ERROR},
		{"研发中心工程", 0, 2, "研发中心工程", DCI_ERROR},
		{"研发中心工程", 2, 6, "研发中心工 ", DCI_ERROR},
		{"研发中心工程", 2, 8, "研发中心工程", DCI_ERROR},
		{"研发中心工程", 2, 0, "研发中心工程", DCI_ERROR},
	};
...
TestLobFlushBuffer_clob()
{
	...
	//begin, add by kqj 20200319, test flag=DCI_LOB_BUFFER_FREE
	for (i = 0; i < (int)sizeof(test_clob) / (int)sizeof(test_clob[0]); i++)
	{
		str_in = test_clob[i].str_in;
		...
		err = DCILobFlushBuffer(pSvcCtx, pError, clob_locp, DCI_LOB_BUFFER_FREE);
		if (err != test_clob[i].ret_val)
		{
			report_error(pError);
			printf("TestLobFlushBuffer_clob: FAILED\n");
...
TestLobFlushBuffer_blob()
{
	...
	for (i = 0; i < (int)sizeof(test_blob) / (int)sizeof(test_blob[0]); i++)
	{
		...
		err = DCILobFlushBuffer(pSvcCtx, pError, blob_locp, DCI_LOB_BUFFER_FREE);
		if (err != test_blob[i].ret_val)
		{
			report_error(pError);
			printf("TestLobFlushBuffer_blob: FAILED\n");
...
//begin, add by kqj, test DCILobOpen(pSvcCtx, pError, lobp[0], DCI_LOB_READONLY)
	...
	if (DCILobOpen(pSvcCtx, pError, lobp[0], DCI_LOB_READONLY) ||
		DCILobOpen(pSvcCtx, pError, lobp[1], DCI_LOB_READONLY))
	{
		ret = DCI_ERROR;
		printf("DCILobOpen failed.\n");
		report_error(pError);
